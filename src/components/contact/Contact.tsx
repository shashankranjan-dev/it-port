  ...
  return (
    <section className="contact section" id="contact">
      ...
      <div className="contact__container container grid">
            ...
            <div className="contact__info">
              <div className="contact__card">
                ...
                <span className="contact__card-data">
                  shuvamhalder2017@gmail.com
                </span>
                <a
                  href="mailto:shuvamhalder2017@gmail.com"
                  target="_blank"
              ...
              <div className="contact__info">
                <div className="contact__card">
                  ...
                  <span className="contact__card-data">+9609604995</span>
                  <a
                    href="https://api.whatsapp.com/send?phone=919609604995&text=Hello, more information!"
                    target="_blank"
                    className="contact__button"
                    rel="noreferrer"
                  >
              ...
              <div className="contact__info">
                <div className="contact__card">
                  ...
                  <span className="contact__card-data">Shuvam Halder</span>
                  <a
                    href="https://m.me/shuvam.halder18/"
                    className="contact__button"
                    target="_blank"
                    rel="noreferrer"
                  >
        ...
        <Slide direction="right" triggerOnce>
          <div className="contact__content">
            <h3 className="contact__title">Tell me about your query</h3>
            ...
            <form className="contact__form" ref={inputRef} onSubmit={sendEmail}>
              ...
              <div className="contact__form-div contact-form-area">
                ...
                <textarea
                  ...
                  rows={10}
                  required
                  placeholder="Write your query in brief..."
                ></textarea>
              </div>
